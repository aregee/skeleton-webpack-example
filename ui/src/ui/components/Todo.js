...
var state = {
  ...
  computed: function (vnode) {
    ...
    state.remaining = state.todos.filter(function (todo) {
      ...
      state.todos.length ? m("footer#footer", [
        ...
        m("ul#filters", [
          m("li", m("a[href='/todo']", {
            ...
            class: state.showing === "" ? "selected" : ""
          }, "All")),
          m("li", m("a[href='/todo/active']", {
            oncreate: m.route.link,
            class: state.showing === "active" ? "selected" : ""
          }, "Active")),
          m("li", m("a[href='/todo/completed']", {
            oncreate: m.route.link,
            class: state.showing === "completed" ? "selected" : ""
          }, "Completed")),
        ]),
